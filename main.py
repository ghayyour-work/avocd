...
def findTotalFuel(remainingFuel, totalFuel):
    currentFuel = math.floor(remainingFuel / 3) - 2
    if currentFuel > 0:
        totalFuel += currentFuel
        return findTotalFuel(currentFuel, totalFuel)
    else:
        return totalFuel


for val in input:
    output_2 += findTotalFuel(val, 0)
